...
import ReactSmartSearch from '../component/ReactSmartSearch'
...
describe('ReactSmartSearch', () => {
  ...
  it('basic render with matchers, displays multiple matchers', () => {
    const result = createReactSmartSearch(multipleMatchers)
    result.assertElementValue('#edit_input', '')
    result.assertElementText('#test_label', '= text')
  ...
  it.each<[string, string]>([
    ...
    const result = createReactSmartSearch(dualMatchers(comp))
  ...
  it('left arrow, moves to previous', async () => {
    const result = createReactSmartSearch(multipleMatchers)
    result.fireKeyDown('#ReactSmartSearch', {
      code: 'ArrowLeft',
      shiftKey: true,
    })
  ...
  it('test validate add', async () => {
    const result = createReactSmartSearch(multipleListMatchers)
...
const createReactSmartSearch = (matchers: Matcher[]): TestHarness => {
